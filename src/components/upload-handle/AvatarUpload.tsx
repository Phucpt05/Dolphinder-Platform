...
import { AvatarUploadProps, UploadState, WalrusResponse } from "../../types";
import { PUBLISHER } from "../../constants";

const AvatarUpload: React.FC<AvatarUploadProps> = ({ onUpload, currentAvatar }) => {
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1">
          <div className="space-y-3">
            <div>
              <label htmlFor="avatar-file" className="block text-sm font-medium text-gray-300 mb-1">
                Avatar Image (Max 10 MiB)
              </label>
              <input
                id="avatar-file"
                type="file"
            ...
            {blobId && (
              <div className="p-3 bg-green-900/50 border border-green-600 rounded-md">
                <p className="text-sm text-green-300 mb-2">✓ Avatar uploaded successfully!</p>
